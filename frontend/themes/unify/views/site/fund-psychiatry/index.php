...
<div class="breadcrumbs">
    <div class="container">
        ...
        <ul class="pull-right breadcrumb">
            ...
            <li><?=Html::a($mText,['/fund-psychiatry/index']);;?></li>
        </ul>
    </div>
</div>
                          ...
                          <a class="btn-u btn-u-green" data-toggle="collapse" data-parent="#sidebar-nav" href="#collapse1">
                             ...
                             <ul id="collapse1" class="collapse">
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. อัตราการเข้าถึงบริการจิตเวชเรื้อรังในชุมชนเทียบกับเป้าหมาย ',
                                                          ['/fund-psychiatry/psychiatry1-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. อัตราการเข้าถึงบริการจิตเวชเรื้อรังในชุมชนเทียบกับเป้าหมาย ',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. อัตราหน่วยบริการแม่ข่ายหรือรพ.พี่เลี้ยง ดําเนินการได้ตามเกณฑ์  ',
                                                          ['/fund-psychiatry/psychiatry2-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. อัตราหน่วยบริการแม่ข่ายหรือรพ.พี่เลี้ยง ดําเนินการได้ตามเกณฑ์  ',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          3. อัตราหน่วยบริการประจําหรือปฐมภมูิ มีศักยภาพดําเนินการได้ตาม เกณฑ์   ',
                                                          ['/fund-psychiatry/psychiatry3-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          3. อัตราหน่วยบริการประจําหรือปฐมภมูิ มีศักยภาพดําเนินการได้ตาม เกณฑ์   ',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          4. อัตราการรับเข้ารักษาซํ้าหรือการกําเริบซํ้าของผู้ป่วยจิตเวชเรื้อรัง ลดลง  ',
                                                          ['/fund-psychiatry/psychiatry4-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          4. อัตราการรับเข้ารักษาซํ้าหรือการกําเริบซํ้าของผู้ป่วยจิตเวชเรื้อรัง ลดลง  ',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          5. อัตราการรับเข้ารักษาใน รพ. ของผู้ป่วยจิตเวชเรื้อรังรายเก่า ลดลง',
                                                          ['/fund-psychiatry/psychiatry5-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          5. อัตราการรับเข้ารักษาใน รพ. ของผู้ป่วยจิตเวชเรื้อรังรายเก่า ลดลง',
                                                          ['site/modal'],
                                                          [
