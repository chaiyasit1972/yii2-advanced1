...
<div class="breadcrumbs">
    <div class="container">
        <h4 class="pull-left">งานอาชีวะอนามัย</h4>
        <ul class="pull-right breadcrumb">
            <li><?=Html::a('Home',['/site/index']);?></li>
            <li><?=Html::a($mText,['/occupa/index']);;?></li>
        </ul>
    </div>
</div>
        ...
        <div id="myCarousel" class="carousel slide carousel-v1">
            <div class="carousel-inner">
                <div class="item active">
                    <img src="<?= $baseUrl ?>/assets/img/occupa1.jpg" alt="">
                </div>
                <div class="item">
                    <img src="<?= $baseUrl ?>/assets/img/occupa2.jpg" alt="">
                </div>         
            </div>
                          ...
                          <a class="btn-u btn-u-orange" data-toggle="collapse" data-parent="#sidebar-nav" href="#collapse1">
                             ...
                             <ul id="collapse1" class="collapse">
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงานอาชีวะอนามัย(Y96) ',
                                                          ['/occupa/occupa1-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          1. รายงานอาชีวะอนามัย(Y96)',
                                                          ['site/modal'],
                                                          [
                                 ...
                                 <li>
                                    <?= !Yii::$app->user->isGuest?
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. รายงานผลการตรวจสุขภาพ(โครงการพิเศษ คัดกรองความเสี่ยงตามกลุ่มโรค)',
                                                          ['/occupa/occupa2-index']) : 
                                            Html::a('<i class="fa fa-arrow-right color-green"></i>
                                                          2. รายงานผลการตรวจสุขภาพ(โครงการพิเศษ คัดกรองความเสี่ยงตามกลุ่มโรค)',
                                                          ['site/modal'],
                                                          [
