    ...
    <div class="container">
        ...
        <ul class="pull-right breadcrumb">
            ...
            <li><?=
                ...
                ;
                ?></li>
            <li class="active"><?= Html::a($names, ['/opd/opd5-index']); ?></li>
        </ul>
    </div>
</div>
...
<div class="alert alert-success margin-left-5 margin-right-5">
...
$this->registerJs("$(function () {
    $('#chart1').highcharts({
        ...
        title: {
            text: 'รายงาน 10 อันดับโรคการส่งต่อผู้ป่วยนอก(9 แผนกหลัก)'
        },
        xAxis: {
            type: 'category'
        },
